...
test('questions, hypotheses, reports, examples, negations and unsupported clauses never issue', () => {
  ...
  const cases = [
    ...
    ['discussion', {text: 'Alice said: your verification code is 123456.'}],
    ['discussion', {text: 'Alice Smith said: your verification code is 123456.'}],
    ...
    ['discussion', {text: 'Coupon code SAVE20\nFrom: Acme\nSent: Tuesday\nSubject: Login\nYour verification code is 123456.'}],
    ['ambiguous', {text: 'Your verification code is\r123456.'}],
    ['ambiguous', {text: 'Your verification code is\u2028123456.'}],
    ['ambiguous', {text: 'Your verification code is\u2029123456.'}],
